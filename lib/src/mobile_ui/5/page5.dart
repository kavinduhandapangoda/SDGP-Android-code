...
class _Page5State extends State<Page5> {
  ...
  Future<dynamic> _getdata() async {
    http.Response response =
        await http.get(Uri.parse("https://agroscan.loopweb.lk/Diseasedata"));
            ...
            child: Container(
              ...
              child: Column(
                children: [
                  ...
                  Container(
                    decoration:
                        BoxDecoration(color: Color.fromARGB(77, 255, 255, 255)),
                    child: Padding(
                      padding: EdgeInsets.only(
                          left: 15.w, right: 15.w, bottom: 200.h, top: 50.h),
